...
ngrok will print a tcp://<host>:<port> mapping — connect remotely with:
...
Add these scripts as separate files in this repo/canvas, or

Convert the scripts into a single make-style installer, or

Produce a shorter README.md variant for GitHub's front page.
